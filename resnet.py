...
writer = SummaryWriter('./logs/(new)base+norm') # Write training results in './logs/' directory
...
optimizer = optim.SGD(model.parameters(), lr=0.01, momentum=0.9) # 나중에 weight decay 포함시키기
